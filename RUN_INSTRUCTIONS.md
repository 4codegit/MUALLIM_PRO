...
Используйте ваш логин и пароль от edonish.tj — они вводятся на экране входа
приложения и **никогда** не хранятся в исходном коде. Если включена опция
«Запомнить меня», сессия сохраняется локально в `~/.edonish_session.json`.
